/** ファイルの書き方について
 * 「# 」の後に何か文字を続けることで、それは見出し・タグとなります
 * 曲は、 「[題名的なsomething] [URL的なSomething]」のようにして、一曲一行で表現します
 * 空行はテキトーに入れてください。空行は無視して読み込む方針です。
 * なんかURLが曲名の後ろに付いていると、このファイルが読みにくくて気持ち悪いんだけど・・・ などの苦情はomasakunまで。
 * 「ひとつの曲にタグをいくつも付けたいんだけど」や「Githubを開かずに曲の追加とかしたいんだけど」、「良いデザイン考えたからデザイン変えてくれ」等の
 * 苦情がある場合にも対応する覚悟はできています。それにもかかわらずそれらをまだ改善していないのは、めんどくさい(=不可抗力)+良いデザインの基準が違う、
 * などが原因です。僕は悪くない。
 * 追記)バンドも方向性の違いで解散しますし（震え声）。
 */
Musics = `
# VOCALOID
- 命に嫌われている :初音ミク https://www.youtube.com/watch?v=0HYm60Mjm0k
- 過ぎて行け :msy / 初音ミク https://www.youtube.com/watch?v=wh0HOVL3wC8
- きみはだいじょうぶ :カルロス袴田 https://www.youtube.com/watch?v=d2yTW64a7Z4
- 七転び八起きない :MAYU / UtataP https://www.youtube.com/watch?v=dTLM7d74w_A
- 永遠に幸せになる方法、見つけました。 :Miku / UtataP https://www.youtube.com/watch?v=ijI5Lkatfqk&index=3&list=PLB0tYbJvyKOhkXayc4GOBbyPdJeFOwadF
- こちら、幸福安心委員会です。 :Miku / UtataP https://www.youtube.com/watch?v=kzUmM-uQVOM&list=PLB0tYbJvyKOhkXayc4GOBbyPdJeFOwadF
...
- 愛き夜道 :たま / ランコ / 雨天決行 https://www.youtube.com/watch?v=pt_kXItJLYE

# HIPHOP
- Ante Up :RainyBlueBell https://www.youtube.com/watch?v=QhzEFAM53eQ
- Rapgloss :RainyBell https://www.youtube.com/watch?v=XsXwDbxjJLg
